...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        seen_sources = set()  # Track unique course/lesson combinations
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Track source for the UI with link information (deduplicated)
...
class CourseOutlineTool(Tool):
    ...
    def _format_course_outline(self, course_meta: Dict[str, Any]) -> str:
        """Format course outline with title, link, and lesson list"""
        ...
        if lessons:
            ...
            for lesson in sorted_lessons:
                ...
                if lesson_num is not None:
                    ...
                    outline_parts.append(f"• {lesson_title}")
        else:
